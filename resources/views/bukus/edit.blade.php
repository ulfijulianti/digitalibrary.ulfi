                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('bukus.update', $bukus->bukuID) }}" method="POST" class="max-w-sm mx-auto">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="tahun_terbit" id="tahun_terbit" name="tahun_terbit" value="{{ $bukus->tahun_terbit }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                        </div>
